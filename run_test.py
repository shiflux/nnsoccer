...
if __name__ == "__main__":
    ...
    print ("Number of 0: " + sum(utils.list_of_0) + " - accuracy: " + str(numpy.mean(utils.list_of_0)))
    print ("Number of 1: " + sum(utils.list_of_1) + " - accuracy: " + str(numpy.mean(utils.list_of_1)))
    print ("Number of 2: " + sum(utils.list_of_2) + " - accuracy: " + str(numpy.mean(utils.list_of_2)))