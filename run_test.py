...
if __name__ == "__main__":
    ...
    print (mn0[1] for mn0 in res)
    print ("Number of 0: " + str(len([e0 for e0 in (mn0[1] for mn0 in res) if e0 == 0])) + " - accuracy: " + str(numpy.mean([e0 for e0 in (mn0[1] for mn0 in res) if e0 == 0])))
