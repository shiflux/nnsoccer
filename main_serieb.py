...
def get_features():
  temp_dict = {}
  response = unirest.get("http://soccer.sportsopendata.net/v1/leagues/serie-b/seasons/16-17/standings",
                         headers={
...
def get_round_data(giornata):
  response = unirest.get(
    "http://soccer.sportsopendata.net/v1/leagues/serie-b/seasons/16-17/rounds/giornata-"+str(giornata),
    headers={
      "X-Mashape-Key": "s52gil4p6Tmshxp5pyFfiTfIYrTlp1dcNCTjsnLJTpnVtyrycd",
      "Accept": "application/json"
    }
